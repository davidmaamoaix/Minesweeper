...
import cn.davidma.gameobject.Background;
import cn.davidma.gameobject.BackgroundBlock;
import cn.davidma.gameobject.Explosion;
import cn.davidma.gameobject.GrassBlock;
import cn.davidma.gameobject.Mine;
import cn.davidma.logic.BlockLogic;
import cn.davidma.logic.BlockLogic.BlockPos;
import cn.davidma.logic.BlockState;
import cn.davidma.logic.TextBuilder;
...
import cn.davidma.neat.object.ui.GameImage;
...
public class Minesweeper extends NeatGame {
	...
	protected void setup() {
		...
		InputManager.setKeyDownHandler(keycode -> {
			if (keycode.equals("R")) {
				this.gameStart();
			}
		});
	...
	protected void gameStart() {
		...
		mainScene.addChild(
			new GameImage(
				PathUtil.fromRelativePath(Minesweeper.class, "resources/images/square.png"),
				CELL_SIZE * FIELD_WIDTH / 2,
				BAR_SIZE / 2,
				CELL_SIZE * FIELD_WIDTH,
				BAR_SIZE
			).setColorEffect(MathUtil.convColorAdjust(85, 80, 30, 0))
		);
		...
		textFlagLeft.setX((int) (CELL_SIZE * FIELD_WIDTH / 2));
